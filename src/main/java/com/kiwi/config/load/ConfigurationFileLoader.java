...
public class ConfigurationFileLoader {
    private static final KiwiLogger log = KiwiLoggerFactory.getLogger(ConfigurationFileLoader.class.getName());
    ...
    private static Properties loadDefault() {
        ...
        try (final var fis = new FileInputStream(DEFAULT_FILE_PATH)) {
            ...
            log.warn("Error during loading default configuration file",  ex.getMessage());
        }
